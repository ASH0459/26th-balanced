...
#define CHASSIS_LEG_MAX_SPEED 1.8f
...
// 跳跃空中/落地阶段的腿长恢复速率。
#define CHASSIS_JUMP_AIRBORNE_LEG_RAMP_SPEED 0.7f
...
#define CHASSIS_SMALL_GYRO_MOVE_PHASE 2.0f
...
#define CHASSIS_DIRECTION_VX_ACCEL_FAST_GAIN 50.0f
