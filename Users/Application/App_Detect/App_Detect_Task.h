...
#define DETECT_PACKED_PREFIX
#define DETECT_PACKED_SUFFIX __attribute__((packed))
#else
#define DETECT_PACKED_PREFIX __packed
#define DETECT_PACKED_SUFFIX
#endif

typedef DETECT_PACKED_PREFIX struct DETECT_PACKED_SUFFIX
{
  uint32_t new_time;
  uint32_t last_time;
  uint32_t lost_time;
...
#undef DETECT_PACKED_PREFIX
#undef DETECT_PACKED_SUFFIX
