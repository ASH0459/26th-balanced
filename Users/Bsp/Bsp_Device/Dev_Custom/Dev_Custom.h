...
static uint8_t _rx_buf_[CUSTOM_QUEUE_ITEM_SIZE]; // 串口接收缓冲区 应该大于最大长度的结构体
...
/**
  ...
  * @retval          none
  */
extern void UART1_ISR_Handler(UART_HandleTypeDef *huart, uint16_t Size);
