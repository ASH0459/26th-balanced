...
void MX_FDCAN2_Init(void)
{
  ...
  hfdcan2.Init.MessageRAMOffset = 1281;
  hfdcan2.Init.StdFiltersNbr = 14;
  hfdcan2.Init.ExtFiltersNbr = 0;
  hfdcan2.Init.RxFifo0ElmtsNbr = 4;
  hfdcan2.Init.RxFifo0ElmtSize = FDCAN_DATA_BYTES_32;
  hfdcan2.Init.RxFifo1ElmtsNbr = 4;
  hfdcan2.Init.RxFifo1ElmtSize = FDCAN_DATA_BYTES_32;
  ...
  hfdcan2.Init.TxElmtSize = FDCAN_DATA_BYTES_32;
